 ...
 * \param com_velocity (optional output) linear velocity of the COM
 * \param angular_momentum (optional output) angular momentum of the model at the COM
 * \param update_kinematics (optional input) whether the kinematics should be updated (defaults to true)
 *
 * \note When only interested in computing the location of the COM you can use
