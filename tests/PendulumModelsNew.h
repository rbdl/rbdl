...
struct DoublePerpendicularPendulumJointCoordinatesNew {
...
struct DoublePerpendicularPendulumAbsoluteCoordinatesNew {
  DoublePerpendicularPendulumAbsoluteCoordinatesNew()
    ...
    cs.AddLoopConstraintNew(0, idB1, X_p1, X_s1, SpatialVector(0,0,0,1,0,0));
    cs.AddLoopConstraintNew(0, idB1, X_p1, X_s1, SpatialVector(0,0,0,0,1,0));
    cs.AddLoopConstraintNew(0, idB1, X_p1, X_s1, SpatialVector(0,0,0,0,0,1));
    cs.AddLoopConstraintNew(0, idB1, X_p1, X_s1, SpatialVector(1,0,0,0,0,0));
    cs.AddLoopConstraintNew(0, idB1, X_p1, X_s1, SpatialVector(0,1,0,0,0,0));


    cs.AddLoopConstraintNew(idB1, idB2, X_p2, X_s2, SpatialVector(0,0,0,1,0,0));
    cs.AddLoopConstraintNew(idB1, idB2, X_p2, X_s2, SpatialVector(0,0,0,0,1,0));
    cs.AddLoopConstraintNew(idB1, idB2, X_p2, X_s2, SpatialVector(0,0,0,0,0,1));
    cs.AddLoopConstraintNew(idB1, idB2, X_p2, X_s2, SpatialVector(1,0,0,0,0,0));
    cs.AddLoopConstraintNew(idB1, idB2, X_p2, X_s2, SpatialVector(0,0,1,0,0,0));
