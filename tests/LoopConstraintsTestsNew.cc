...
struct FourBarLinkageNew {
  ...
  FourBarLinkageNew()
    ...
    cs.AddLoopConstraintNew(idB2, idB5, X_p, X_s,
...
struct FloatingFourBarLinkageNew {

  FloatingFourBarLinkageNew()
    : model()
    , cs()
    , q()
    , qd()
...
struct SliderCrank3DNew {
  ...
  SliderCrank3DNew()
    ...
    cs.AddLoopConstraintNew(id_p, id_s, X_p, X_s,
                         SpatialVector(0,0,0,1,0,0), true, 0.1);
    cs.AddLoopConstraintNew(id_p, id_s, X_p, X_s,
                         SpatialVector(0,0,0,0,1,0), true, 0.1);
    cs.AddLoopConstraintNew(id_p, id_s, X_p, X_s,
...
struct SliderCrank3DNewSphericalJointNew {

  SliderCrank3DNewSphericalJointNew()
    : model()
    , cs()
    , q()
    , qd()
...
TEST_FIXTURE(FourBarLinkageNew, TestFourBarLinkageNewConstraintErrors) {
...
TEST_FIXTURE(FourBarLinkageNew, TestFourBarLinkageNewConstraintJacobian) {
...
TEST_FIXTURE(FourBarLinkageNew, TestFourBarLinkageNewConstraintsVelocityErrors) {
...
TEST_FIXTURE(FourBarLinkageNew, TestFourBarLinkageNewQAssembly) {
...
TEST_FIXTURE(FourBarLinkageNew, TestFourBarLinkageNewQDotAssembly) {
  VectorNd weights(q.size());
...
TEST_FIXTURE(FourBarLinkageNew, TestFourBarLinkageNewForwardDynamics) {
  VectorNd qddDirect;
...
TEST_FIXTURE(FourBarLinkageNew, FourBarLinkageNewImpulse) {
...
TEST_FIXTURE(SliderCrank3DNew, TestSliderCrank3DNewConstraintErrors) {
  VectorNd err(VectorNd::Zero(cs.size()));
  VectorNd errRef(VectorNd::Zero(cs.size()));
  Vector3d pos_p;
  Vector3d pos_s;
...
TEST_FIXTURE(SliderCrank3DNew, TestSliderCrank3DNewConstraintJacobian) {
  MatrixNd G(MatrixNd::Zero(cs.size(), q.size()));
...
TEST_FIXTURE(SliderCrank3DNew, TestSliderCrank3DNewConstraintsVelocityErrors) {
  VectorNd errd(VectorNd::Zero(cs.size()));
  VectorNd errdRef(VectorNd::Zero(cs.size()));
  MatrixNd G(cs.size(), model.dof_count);
...
TEST_FIXTURE(SliderCrank3DNew, TestSliderCrank3DNewAssemblyQ) {
  VectorNd weights(q.size());
  VectorNd qInit(q.size());
...
TEST_FIXTURE(SliderCrank3DNew, TestSliderCrank3DNewAssemblyQDot) {
  VectorNd qWeights(q.size());
...
TEST_FIXTURE(SliderCrank3DNew, TestSliderCrank3DNewForwardDynamics) {
  VectorNd qWeights(q.size());
  VectorNd qdWeights(q.size());
  VectorNd qInit(q.size());
  VectorNd qdInit(q.size());
...
TEST_FIXTURE(SliderCrank3DNew, TestSliderCrank3DNewImpulse) {
  VectorNd qdPlusDirect(qd.size());
  VectorNd qdPlusRangeSpaceSparse(qd.size());
  VectorNd qdPlusNullSpace(qd.size());
...
TEST_FIXTURE(FloatingFourBarLinkageNew
  , TestFloatingFourBarLinkageNewConstraintErrors) {
...
TEST_FIXTURE(FloatingFourBarLinkageNew
  , TestFloatingFourBarLinkageNewConstraintJacobian) {
...
TEST_FIXTURE(FloatingFourBarLinkageNew
  , TestFloatingFourBarLinkageNewConstraintsVelocityErrors) {
...
TEST_FIXTURE(FloatingFourBarLinkageNew, TestFloatingFourBarLinkageNewQAssembly) {
  VectorNd weights(q.size());
  VectorNd err(cs.size());
  VectorNd errRef(VectorNd::Zero(cs.size()));
...
TEST_FIXTURE(FloatingFourBarLinkageNew, TestFloatingFourBarLinkageNewQDotAssembly) {
  VectorNd weights(q.size());
...
TEST_FIXTURE(FloatingFourBarLinkageNew
  , TestFloatingFourBarLinkageNewForwardDynamics) {
...
TEST_FIXTURE(FloatingFourBarLinkageNew, TestFloatingFourBarLinkageNewImpulse) {
  VectorNd qdPlusDirect(qd.size());
  VectorNd qdPlusRangeSpaceSparse(qd.size());
  VectorNd qdPlusNullSpace(qd.size());
  VectorNd errd(cs.size());
...
TEST_FIXTURE(SliderCrank3DNewSphericalJointNew
  , TestSliderCrank3DNewSphericalJointNewConstraintErrors) {
  VectorNd err(VectorNd::Zero(cs.size()));
  VectorNd errRef(VectorNd::Zero(cs.size()));
  Vector3d pos_p;
  Vector3d pos_s;
...
TEST_FIXTURE(SliderCrank3DNewSphericalJointNew
  , TestSliderCrank3DNewSphericalJointNewConstraintJacobian) {
...
TEST_FIXTURE(SliderCrank3DNewSphericalJointNew
  , TestSliderCrank3DNewSphericalJointNewConstraintsVelocityErrors) {
  VectorNd errd(VectorNd::Zero(cs.size()));
  VectorNd errdRef(VectorNd::Zero(cs.size()));
  MatrixNd G(cs.size(), model.dof_count);
...
TEST_FIXTURE(SliderCrank3DNewSphericalJointNew
  , TestSliderCrank3DNewSphericalJointNewAssemblyQ) {
...
TEST_FIXTURE(SliderCrank3DNewSphericalJointNew
  , TestSliderCrank3DNewSphericalJointNewAssemblyQDot) {
  VectorNd qWeights(model.dof_count);
...
TEST_FIXTURE(SliderCrank3DNewSphericalJointNew
  , TestSliderCrank3DNewSphericalJointNewForwardDynamics) {
...
TEST_FIXTURE(SliderCrank3DNewSphericalJointNew
  , TestSliderCrank3DNewSphericalJointNewImpulse) {
...
TEST(ConstraintCorrectnessTestNew) {
  DoublePerpendicularPendulumAbsoluteCoordinatesNew dba
    = DoublePerpendicularPendulumAbsoluteCoordinatesNew();
  DoublePerpendicularPendulumJointCoordinatesNew dbj
    = DoublePerpendicularPendulumJointCoordinatesNew();
