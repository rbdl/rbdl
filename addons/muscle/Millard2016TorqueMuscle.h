              ...
              \tau (\mathbf{a}, \theta,\dot{\theta}) =
                  \begin{cases}
                    \tau_{ISO} ( \mathbf{a} \, \mathbf{t}_A(\theta) \mathbf{t}_V(\dot{\theta}/\dot{\theta}_{MAX})
                              - \beta \dot{\theta}/\dot{\theta}_{MAX}
                              +  s_P \mathbf{t}_P(\theta-\theta_S) \, ) & \text{ if } \,\, \tau (\mathbf{a}, \theta,\dot{\theta}) > 0 \\
        ...
        class Millard2016TorqueMuscle {
            ...
            public:
                ...
                */
                ...
                /**
                  @return The normalized damping term \f$\beta\f$ term
            ...
            private:
              ...
              */
              ...
              double beta; //passive damping coefficient
