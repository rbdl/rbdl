...
/** Create a matrix from 5x5 values.
 *
 * The layout assumed for the values is that of the matrix being assigned.
 */
#define CML_ASSIGN_MAT_55                                               \
matrix_type&                                                            \
set(                                                                    \
    ELEMENT_ARG_TYPE e00, ELEMENT_ARG_TYPE e01, ELEMENT_ARG_TYPE e02,   \
    ELEMENT_ARG_TYPE e03, ELEMENT_ARG_TYPE e04,                         \
                                                                        \
    ELEMENT_ARG_TYPE e10, ELEMENT_ARG_TYPE e11, ELEMENT_ARG_TYPE e12,   \
    ELEMENT_ARG_TYPE e13, ELEMENT_ARG_TYPE e14,                         \
                                                                        \
    ELEMENT_ARG_TYPE e20, ELEMENT_ARG_TYPE e21, ELEMENT_ARG_TYPE e22,   \
    ELEMENT_ARG_TYPE e23, ELEMENT_ARG_TYPE e24,                         \
                                                                        \
    ELEMENT_ARG_TYPE e30, ELEMENT_ARG_TYPE e31, ELEMENT_ARG_TYPE e32,   \
    ELEMENT_ARG_TYPE e33, ELEMENT_ARG_TYPE e34,                         \
                                                                        \
    ELEMENT_ARG_TYPE e40, ELEMENT_ARG_TYPE e41, ELEMENT_ARG_TYPE e42,   \
    ELEMENT_ARG_TYPE e43, ELEMENT_ARG_TYPE e44                          \
    )                                                                   \
{                                                                       \
    _DO_MATRIX_SET_RESIZE(5,5);                                         \
    /* This is overkill, but simplifies size checking: */               \
    value_type v[5][5] = {                                              \
        {e00,e01,e02,e03,e04},                                          \
        {e10,e11,e12,e13,e14},                                          \
    ...
    typedef et::OpAssign<Element,Element> OpT;                          \
    typedef const value_type element;                                   \
    cml::matrix<element, external<5,5>, basis_orient, row_major>        \
        src(&v[0][0]);                                                  \
    et::UnrollAssignment<OpT>(*this,src);                               \
    return *this;                                                       \
}

/** Create a matrix from 6x6 values.
 *
 * The layout assumed for the values is that of the matrix being assigned.
 */
#define CML_ASSIGN_MAT_66                                               \
matrix_type&                                                            \
set(                                                                    \
    ELEMENT_ARG_TYPE e00, ELEMENT_ARG_TYPE e01, ELEMENT_ARG_TYPE e02,   \
    ELEMENT_ARG_TYPE e03, ELEMENT_ARG_TYPE e04, ELEMENT_ARG_TYPE e05,   \
                                                                        \
    ELEMENT_ARG_TYPE e10, ELEMENT_ARG_TYPE e11, ELEMENT_ARG_TYPE e12,   \
    ELEMENT_ARG_TYPE e13, ELEMENT_ARG_TYPE e14, ELEMENT_ARG_TYPE e15,   \
                                                                        \
    ELEMENT_ARG_TYPE e20, ELEMENT_ARG_TYPE e21, ELEMENT_ARG_TYPE e22,   \
    ELEMENT_ARG_TYPE e23, ELEMENT_ARG_TYPE e24, ELEMENT_ARG_TYPE e25,   \
                                                                        \
    ELEMENT_ARG_TYPE e30, ELEMENT_ARG_TYPE e31, ELEMENT_ARG_TYPE e32,   \
    ELEMENT_ARG_TYPE e33, ELEMENT_ARG_TYPE e34, ELEMENT_ARG_TYPE e35,   \
                                                                        \
    ELEMENT_ARG_TYPE e40, ELEMENT_ARG_TYPE e41, ELEMENT_ARG_TYPE e42,   \
    ELEMENT_ARG_TYPE e43, ELEMENT_ARG_TYPE e44, ELEMENT_ARG_TYPE e45,   \
                                                                        \
    ELEMENT_ARG_TYPE e50, ELEMENT_ARG_TYPE e51, ELEMENT_ARG_TYPE e52,   \
    ELEMENT_ARG_TYPE e53, ELEMENT_ARG_TYPE e54, ELEMENT_ARG_TYPE e55    \
    )                                                                   \
{                                                                       \
    _DO_MATRIX_SET_RESIZE(6,6);                                         \
    /* This is overkill, but simplifies size checking: */               \
    value_type v[6][6] = {                                              \
    ...
    typedef et::OpAssign<Element,Element> OpT;                          \
    typedef const value_type element;                                   \
    cml::matrix<element, external<6,6>, basis_orient, row_major>        \
        src(&v[0][0]);                                                  \
    et::UnrollAssignment<OpT>(*this,src);                               \
    return *this;                                                       \
}
